...
import { BAR_TOKENS } from "./defaults";
...
export function BarTab({
  ...
  page?: "layout" | "behavior" | "notifications";
}) {
  ...
  return (
    <SettingsSection
      ...
      onReset={() =>
        setConfigsSequentially([
          ...pageDefaults(page),
          ...(page === "layout" ? [clearTokens(BAR_TOKENS)] : []),
        ])
      }
    >
      {page === "layout" && (
